    ...
    <section className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100 ">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <button onClick={()=>addToCart(productData._id, sizes)} className="text-white px-8 py-3 bg-black text-sm active:bg-gray-7900 ">
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            dolore autem magnam repellat libero aut asperiores modi, impedit,
            culpa necessitatibus incidunt officiis, reiciendis quis nobis
            nesciunt. Minus impedit est optio harum consectetur quia. Nesciunt
            nisi voluptate animi magni iste.
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea est
            ipsa voluptatum veniam iure doloribus!
          </p>
        </div>
      </div>
      {/*----------------------display related are------------------ */}
